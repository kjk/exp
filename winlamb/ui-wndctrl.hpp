...
namespace wl::events {
	...
	public:
		void bcn_drop_down(Func1<NMBCDROPDOWN&> cb);
		void bcn_hot_item_change(Func1<NMBCHOTITEM&> cb);
		void bn_clicked(Func0 cb);
		void bn_dbl_clk(Func0 cb);
		void bn_kill_focus(Func0 cb);
		void bn_set_focus(Func0 cb);
	...
	public:
		void cbn_close_up(Func0 cb);
		void cbn_dbl_clk(Func0 cb);
		void cbn_drop_down(Func0 cb);
		void cbn_edit_change(Func0 cb);
		void cbn_edit_update(Func0 cb);
		void cbn_kill_focus(Func0 cb);
		void cbn_sel_change(Func0 cb);
		void cbn_sel_end_cancel(Func0 cb);
		void cbn_sel_end_ok(Func0 cb);
		void cbn_set_focus(Func0 cb);
	...
	public:
		void dtn_close_up(Func0 cb);
		void dtn_date_time_change(Func1<NMDATETIMECHANGE&> cb);
		void dtn_drop_down(Func0 cb);
		void dtn_format(Func1<NMDATETIMEFORMATW&> cb);
		void dtn_format_query(Func1<NMDATETIMEFORMATQUERYW&> cb);
		void dtn_user_string(Func1<NMDATETIMESTRINGW&> cb);
		void dtn_wm_key_down(Func1<NMDATETIMEWMKEYDOWNW&> cb);
		void nm_kill_focus(Func0 cb);
		void nm_set_focus(Func0 cb);
	...
	public:
		void en_change(Func0 cb);
		void en_h_scroll(Func0 cb);
		void en_kill_focus(Func0 cb);
		void en_max_text(Func0 cb);
		void en_set_focus(Func0 cb);
		void en_update(Func0 cb);
		void en_v_scroll(Func0 cb);
	...
	public:
		void lvn_begin_drag(Func1<NMLISTVIEW&> cb);
		void lvn_begin_label_edit(std::function<bool(NMLVDISPINFOW&)> &&cb);
		void lvn_begin_r_drag(Func1<NMLISTVIEW&> cb);
		void lvn_begin_scroll(Func1<NMLVSCROLL&> cb);
		void lvn_column_click(Func1<NMLISTVIEW&> cb);
		void lvn_column_drop_down(Func1<NMLISTVIEW&> cb);
		void lvn_column_overflow_click(Func1<NMLISTVIEW&> cb);
		void lvn_delete_all_items(std::function<bool(NMLISTVIEW&)> &&cb);
		void lvn_delete_item(Func1<NMLISTVIEW&> cb);
		void lvn_end_label_edit(std::function<bool(NMLVDISPINFOW&)> &&cb);
		void lvn_end_scroll(Func1<NMLVSCROLL&> cb);
		void lvn_insert_item(Func1<NMLISTVIEW&> cb);
		void lvn_item_activate(Func1<NMITEMACTIVATE&> cb);
		void lvn_item_changed(Func1<NMLISTVIEW&> cb);
		void lvn_item_changing(std::function<bool(NMLISTVIEW&)> &&cb);
		void lvn_key_down(Func1<NMLVKEYDOWN&> cb);
		void nm_click(Func1<NMITEMACTIVATE&> cb);
		void nm_custom_draw(std::function<DWORD(NMLVCUSTOMDRAW&)> &&cb);
		void nm_dbl_clk(Func1<NMITEMACTIVATE&> cb);
		void nm_kill_focus(Func1<NMHDR&> cb);
		void nm_r_click(Func1<NMITEMACTIVATE&> cb);
		void nm_r_dbl_clk(Func1<NMITEMACTIVATE&> cb);
		void nm_released_capture(Func1<NMHDR&> cb);
		void nm_set_focus(Func1<NMHDR&> cb);
	...
	public:
		void mcn_get_day_state(Func1<NMDAYSTATE&> cb);
		void mcn_sel_change(Func1<NMSELCHANGE&> cb);
		void mcn_select(Func1<NMSELCHANGE&> cb);
		void mcn_view_change(Func1<NMVIEWCHANGE&> cb);
		void nm_released_capture(Func0 cb);
	...
	public:
		void bn_clicked(Func1<int> cb);
		void bn_dbl_clk(Func1<int> cb);
		void bn_kill_focus(Func1<int> cb);
		void bn_set_focus(Func1<int> cb);
	...
	public:
		void stn_clicked(Func0 cb);
		void stn_dbl_clk(Func0 cb);
		void stn_disable(Func0 cb);
		void stn_enable(Func0 cb);
	...
	public:
		...
		void sbn_simple_mode_change(Func1<NMMOUSE&> cb);
	...
	public:
		void tcn_focus_change(Func0 cb);
		void tcn_get_object(Func1<NMOBJECTNOTIFY&> cb);
		void tcn_key_down(Func1<NMTCKEYDOWN&> cb);
		void tcn_sel_change(Func0 cb);
		void tcn_sel_changing(std::function<bool()> &&cb);
		void nm_click(Func0 cb);
		void nm_dbl_clk(Func0 cb);
		void nm_r_click(Func0 cb);
		void nm_r_dbl_clk(Func0 cb);
		void nm_released_capture(Func0 cb);
	...
	public:
		...
		void wm_h_scroll(Func1<wm::HScroll&> cb);
		void wm_v_scroll(Func1<wm::VScroll&> cb);
		void nm_custom_draw(std::function<DWORD(NMCUSTOMDRAW&)> &&cb);
		void nm_released_capture(Func0 cb);
	...
	public:
		void tvn_async_draw(Func1<NMTVASYNCDRAW&> cb);
		void tvn_begin_drag(Func1<NMTREEVIEWW&> cb);
		void tvn_begin_label_edit(std::function<bool(NMTVDISPINFOW&)> &&cb);
		void tvn_begin_r_drag(Func1<NMTREEVIEWW&> cb);
		void tvn_delete_item(Func1<NMTREEVIEWW&> cb);
		void tvn_end_label_edit(std::function<bool(NMTVDISPINFOW&)> &&cb);
		void tvn_get_disp_info(Func1<NMTVDISPINFOW&> cb);
		void tvn_get_info_tip(Func1<NMTVGETINFOTIPW&> cb);
		void tvn_item_changed(Func1<NMTVITEMCHANGE&> cb);
		void tvn_item_changing(std::function<bool(NMTVITEMCHANGE&)> &&cb);
		void tvn_item_expanded(Func1<NMTREEVIEWW&> cb);
		void tvn_item_expanding(std::function<bool(NMTREEVIEWW&)> &&cb);
		void tvn_key_down(std::function<int(NMTVKEYDOWN&)> &&cb);
		void tvn_sel_changed(Func1<NMTREEVIEWW&> cb);
		void tvn_sel_changing(std::function<bool(NMTREEVIEWW&)> &&cb);
		void tvn_set_disp_info(Func1<NMTVDISPINFOW&> cb);
...
namespace wl {
	...
	public:
		...
		class ItemCollection final : private wl::NoCopyNoMove {
		private:
			constexpr explicit ItemCollection(const ListView &owner) : _owner{owner}, _lastResult{owner, -1} { }
		...
		public:
			...
			[[nodiscard]] Item* get_by_unique_id(UINT uid);
			...
			[[nodiscard]] Item* hit_test(POINT pt);
			...
			[[nodiscard]] Item* topmost_visible();
	...
	public:
		...
		class ItemCollection final : private wl::NoCopyNoMove {
		private:
			constexpr explicit ItemCollection(Tab &owner) : _owner{owner}, _lastResult{owner, -1} { }
